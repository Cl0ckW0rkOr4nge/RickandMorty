        ...
        <article className='card'>
            ...
            <section className='card_body'>
                ...
                <ul className='card_list'>
                    <li className='card_item'><span>Specie: </span>
                    {resident?.species}</li>
                    <li className='card_item'><span>Origin: </span>
                    {resident?.origin.name}</li>
                    <li className='card_item'><span>Episodes where appear: </span>
                    {resident?.episode.length}</li>
                </ul>
            </section>
        </article>
